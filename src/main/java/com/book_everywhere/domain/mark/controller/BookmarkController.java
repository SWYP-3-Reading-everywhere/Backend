...
public class BookmarkController {
    ...
    public CMRespDto<?> findBookmarkWithUser(@RequestParam Long socialId) {
    ...
    public CMRespDto<?> saveBookmark(@PathVariable Long socialId, @PathVariable String address) {
    ...
    public CMRespDto<?> deleteBookmark(@RequestParam Long bookmarkId) {
